...
CONFIG_TMR0: ;CONFIGURACION DE TMR0
    ...
    MOVLW 01010000B ;SELECCIONAMOS SÓLO LOS BITS ((OPTION_REG) and 07Fh), 3(0),((OPTION_REG) and 07Fh), 2,((OPTION_REG) and 07Fh), 1,((OPTION_REG) and 07Fh), 0, TOSC(0), a RBPU(0)
 ...
 CONFIG_INT_ENABLE:
    ...
    BSF ((INTCON) and 07Fh), 3 ;HABILITAMOS LAS INTERRUPCIONES INTERRUP-ON-CHANGE
