...
; Hardware: PUSH EN EL PUERTO B, DISPLAY 7 SEGEMENTOS EN EL PUERTO C & D, LEDS EN EL PUERTO A
;
...
DECIMALES_C:
    ...
    BTFSC STATUS, 0 ;VERIFICAMOS LA BANDERA ((STATUS) and 07Fh), 0
...
DECIMALES_D:
    ...
    BTFSC STATUS, 0 ;VERIFIACMOS LA BANDERA DE ((STATUS) and 07Fh), 0
    INCF DECENA, 1 ;INCREMENTAMOS A DECENA
    BTFSC STATUS, 0 ;VERIFIACMOS LA BANDERA DE ((STATUS) and 07Fh), 0
    GOTO $-4
    ADDWF DECIMAL,F
    RETURN
UNIDADES_D:
    ...
    SUBWF DECIMAL,F ;RESTAMOS 1 A LA VARIABLES
    BTFSC STATUS, 0 ;VERIFIACMOS LA BANDERA DE ((STATUS) and 07Fh), 0
    INCF UNIDADES, 1 ;INCREMENTAMOS UNIDADES
    BTFSC STATUS, 0 ;VERIFIACMOS LA BANDERA DE ((STATUS) and 07Fh), 0
    GOTO $-4
    ADDWF DECIMAL,F ;LA VARIABLE SE QUEDA EN VALOR DE 0
    RETURN
 VALORES_DISP2:
 ...
 DISPLAY1:
    ...
    BTFSC FLAG, 0 ;VERIFICAMOS A QUE DISPLAY CARGAMOS EL VALOR
    GOTO DISPLAY_1_1
    BTFSC FLAG, 1
    GOTO DISPLAY_1_0
    BTFSC FLAG, 2
 ...
 DISPLAY_2_2:
    ...
    MOVWF PORTC ;COLOCAMOS EL VALOR DE UNIDADES AL DISPLAY2
    BSF PORTD, 4
    MOVLW 00000000B ;VALOR PARA REVISAR LA BANDERA DISP1
    GOTO CAMBIO_DISP
 CAMBIO_DISP:
    MOVWF FLAG, F ;CAMBIAMOS LA BANDERA
    RETURN
