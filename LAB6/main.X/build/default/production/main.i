...
;-------------------------VECTOR RESET ----------------------------------------
 ...
 ISR:
    ...
    BTFSC ((PIR1) and 07Fh), 0 ;REVISAMOS LA BANDERA ((PIR1) and 07Fh), 0
...
;-----------------------SUB RUTINAS DE CONFIGURACION ---------------------------
 ...
 CONFIG_TMR0: ;CONFIGURACION DE TMR0
    ...
    MOVLW 11010000B ;SELECCIONAMOS SÓLO LOS BITS ((OPTION_REG) and 07Fh), 3(0),((OPTION_REG) and 07Fh), 2,((OPTION_REG) and 07Fh), 1,((OPTION_REG) and 07Fh), 0, TOSC(0), a RBPU(0) HABILITA PULL UP
 ...
 CONFIG_INT_ENABLE:
    ...
    BSF ((PIE1) and 07Fh), 0 ;HABILITAMOS LA INTERRUPCION DE OVERFLOW DE TMR1
    BSF ((PIE1) and 07Fh), 1 ;HABILITAMOS LA INTERRUPCION DE OVERFLOW DE TMR1
    BCF ((INTCON) and 07Fh), 2 ;LIMPIAMOS LA BANDERA DEL TMR0
    BCF ((PIR1) and 07Fh), 0 ;LIMPIAMOS LA BANDERA DEL TMR1
    BCF ((PIR1) and 07Fh), 1 ;LIMPIAMOS LA BANDERA DEL TMR1
    RETURN
 ...
 TMR1_RESTART:
    ...
    MOVWF TMR1L
    BCF PIR1, 0 ;LIMPIAMOS BANDERA ((PIR1) and 07Fh), 0
    RETURN
 ...
 INC_VARIABLE:
  ...
  LED_BLINK:
    CALL TMR2_RESTART ;LLAMAMOS A LA SUBRUTINA DE RESTART TMR2
    INCF CONT_TMR2
