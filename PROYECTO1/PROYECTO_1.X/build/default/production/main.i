...
;
; Programa: PROYECTO
; Hardware: PUSH EN EL PUERTO B, DISPLAY 7 SEGEMENTOS EN EL PUERTO C, LEDS EN EL PUERTO A, CONTROL DE TRANSISTORES PUERTO D
;
; Creado: 14 de marzo, 2021
; Última modificación: 14 de marzo, 2021
