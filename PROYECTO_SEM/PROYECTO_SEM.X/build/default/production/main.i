...
VER3 EQU 7
  ...
  GLOBAL W_TEMP, TVIA1, TVIA2, TVIA3, DECENAS1, UNIDADES1, DISP1, T_VIA1, SMODO
...
CONFIG_IOCRB:
 ...
 COLOR_RED3:
  ...
  S_MODO:
    BTFSS PORTB, MODO
    CALL ANTI_REB1 ;ANTIREBOTE DE DEL PORTB 2
    RETURN

  ANTI_REB1: ;ANTIREBOTE PUSH PORTB2
    BSF AREB, 0 ;ENCENDEMOS NUESTRA BANDERA DE ANTIREBOTE 1
    BCF ((INTCON) and 07Fh), 0
    RETURN

  CAMBIAR_MODO:
    BTFSS PORTB, MODO ;MIRAMOS QUE LA BANDERA 0 ESTE ACTIVA
